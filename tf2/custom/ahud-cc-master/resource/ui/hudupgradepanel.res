"Resource/UI/HudUpgradePanel.res"
{
	...
	"SelectWeaponPanel"
	{
		...
		"TopBorder"
		{
			...
			"bgcolor_override"	"70 70 70 255"	// was ahudWhite - match dark theme
		}
		"BottomBorder"
		{
			"ControlName"	"Panel"
		...
		"ActiveTabPanel"
		{
			...
			"enabled"		"1"
			"tabPosition"		"0"
			"bgcolor_override"	"70 70 70 255"	// was ahudWhite - match strip buttons
			"PaintBackgroundType"	"0"
		}
		...
		"CancelButton"
		{
			...
			"enabled"		"1"
			"tabPosition"	"0"
			"defaultBgColor_override"	"70 70 70 255"	// visible on dark strip
			"armedBgColor_override"		"115 115 115 255"
			"depressedBgColor_override"	"90 90 90 255"
